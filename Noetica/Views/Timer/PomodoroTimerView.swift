...
struct PomodoroTimerView: View {
    ...
    var body: some View {
            ...
            .toolbar {
                ...
                ToolbarItem(placement: .navigationBarTrailing) {
                    Button(action: {
                        ...
                        Image(systemName: isActive ? "pause.circle" : "arrow.clockwise")
        ...
        .alert("Exit Timer Session?", isPresented: $showingExitConfirmation) {
            ...
            Text(isActive ? "Your timer is currently running. Do you want to keep it running in the background or stop it?" : "Are you sure you want to exit?")
        }
